...
{
	char response = 'Y';
	int User_Modification;
	while (response == 'Y')
	{
		cout << "What do you want to modify press 1 for account|| 2 for Name ||3 for Type || 4 for Balance" << endl;
		cin >> User_Modification; 
		switch (User_Modification)
		{
		case 1:
		{
			cout << "\nAccount No. :" << endl;
		...
		cout << "Do you change anything else Enter Y for Yes or N for No" << endl;
		cin >> response;
	}
}
